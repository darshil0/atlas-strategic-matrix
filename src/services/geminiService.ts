/**
 * Atlas Gemini Service Layer (v3.6.0) - Glassmorphic Enterprise LLM
 ...
 *
 * FIX v3.6.0: Corrected the timeout/race-condition pattern in `generatePlan`.
...
export class AtlasService {
   ...
   *
   * FIX v3.6.0: The timeout race now wraps `generateContent` itself rather than
