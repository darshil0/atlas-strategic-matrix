/**
 * Atlas Development Kit (ADK) Core Barrel (v3.6.0)
 ...
 * FIX v3.6.0: Removed self-referential circular import (was `import('./index')`).
...
export const bootstrapADK = async (): Promise<boolean> => {
  try {
    ...
    if (ENV.DEBUG_MODE) {
      console.group("🏛️ ATLAS ADK v3.6.0 BOOTSTRAP");
